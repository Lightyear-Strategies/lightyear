...
def signup():
    ...
    if form.validate_on_submit():
        ...
        mp.track(user.email, 'Sign Up', {'session_id': request.cookies.get('session')}, meta={'session_id': request.cookies.get('session')})
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if "@" in form.email.data:
            ...
            mp.track(user.email, 'Login', {'session_id': request.cookies.get('session')}, meta={'session_id': request.cookies.get('session')})
